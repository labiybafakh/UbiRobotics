  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  RTC::TimedVelocity2D m_outVelocity;
  /*!
   */
  RTC::InPort<RTC::TimedVelocity2D> m_outVelocityIn;
  ...
  RTC::TimedShort m_velocityCam;
  /*!
   */
  RTC::OutPort<RTC::TimedShort> m_velocityCamOut;
  RTC::TimedVelocity2D m_inVelocity;
  /*!
   */
  RTC::OutPort<RTC::TimedVelocity2D> m_inVelocityOut;
